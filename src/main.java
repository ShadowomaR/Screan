...
public class main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Users\\SHADOW\\Pictures\\shadow.png"));
        setResizable(false);
        ...
        setSize(new java.awt.Dimension(89, 61));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            Image ima=R.createScreenCapture(rc);
            ...
            ImageIO.write((RenderedImage) ima, "jpg", new File(r.getSelectedFile().getAbsolutePath()+"\\Image_"+dtf.format(now)+".jpg"));
